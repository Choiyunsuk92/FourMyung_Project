...
public class MailAction {
	...
	public void sendMail(String reciver, String userId) throws MessagingException{
		...
		String content = "<html><body>"
				       ...
				       + "<a href='http://localhost:9090/mem/"
	...
	public void sendMail1(String reciver, String empId) throws MessagingException{
		MimeMessage msg = mailSender.createMimeMessage();
		SimpleDateFormat dateForm = new SimpleDateFormat("yyyyMMddHHmmss");
		String num = dateForm.format(new Date());
		String content = "<html><body>"
				+ "안녕하세요 '" + empId +"'님 가입을 환영합니다.<br />"
				+ "아래 링크를 눌러야 가입이 완료가 됩니다. <br />"
				+ "<a href='http://localhost:9090/emp/"
				+ "memberMail?num="+num+"&reciver="+reciver+"&empId="+empId+"'>"
				+ "<strong><b>"
				+ "가입을 완료하시려면 여기를 눌러주세요.</a>"
				+ "</b></strong>"
				+ "</body></html>";
